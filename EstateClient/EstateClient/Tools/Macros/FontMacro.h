...
#define nav_text_font       [UIFont systemFontOfSize:21]
#define tab_text_font       [UIFont systemFontOfSize:13]
#define big_text_font       [UIFont systemFontOfSize:17]
#define normal_text_font    [UIFont systemFontOfSize:15]
#define small_text_font     [UIFont systemFontOfSize:13]
...
#define font_Helvetica_33   [UIFont fontWithName:@"Helvetica" size:33.0]
...
#define font_HelveticaBold_33   [UIFont fontWithName:@"Helvetica-Bold" size:33.0]
