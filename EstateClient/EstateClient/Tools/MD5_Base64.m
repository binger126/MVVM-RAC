...
+ (NSString *)base64_Md5String:(NSString *)string {
    NSMutableArray *mutArray = [MD5_Base64 md5:string];
    Byte bys[16];
    ...
    //base64再编码
    NSData *nsdata = [[NSData alloc] initWithBytes:bys length:16];
    NSString *baseJson = [nsdata base64EncodedStringWithOptions:0];
    return baseJson;
}
